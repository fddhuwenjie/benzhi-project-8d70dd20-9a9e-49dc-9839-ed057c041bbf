...
func Open(root string) (*Repository, error) {
	...
	r := &Repository{root: root, batchDir: filepath.Join(root, "batches"), requestDir: filepath.Join(root, "requests"), manifestDir: filepath.Join(root, "manifests"), quarantine: filepath.Join(root, "quarantine")}
